package com.digitalfacory.thechampion.swagger;
...
public class SwaggerConfig {
	...
	private static final  ApiInfo DEFAULT_API_INFO = 
			new ApiInfo("The champion System", "System to manage tennis table league for Digital Factory.", "1.0", "tof", DEFAULT_CONTACT, "", "");
